...
require_once(__DIR__ . '/../../Config/conexion_be.php');
...
class LibroValidatorService {
   ...
   /*
    public function validarEliminacionLibro($libroID) {
        $stmt = mysqli_prepare($this->enlace, "SELECT libroID FROM prestamo WHERE libroID = ? AND estado_prestamo = 'activo'");
