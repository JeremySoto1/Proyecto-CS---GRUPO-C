<?php
require_once __DIR__.'/../Modelo/libros_modelo.php';// Incluye el archivo del modelo para operaciones con libros
require_once __DIR__.'/../../Login/validar_sesion.php';// Incluye el archivo para validar la sesión del usuario
...
function procesarFormularioLibros() {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        try {
            ...
            header("Location: ../Vista/libros_vista.php?error=".urlencode($e->getMessage())."&code=".$e->getCode());
            exit();
