...
require_once '../../Controlador/Session/validar_sesion.php'; // Verifica la ruta
...
<body>
    <?php include __DIR__ . '/../Helpers/templates/sidebar.php'; ?>
    ...
    <div class="main-content">
        ...
        <div class="content">
                        ...
                        <?php foreach ($libros as $libro): ?>
                            <tr id="fila-<?= $libro['libroID'] ?>">
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="../../Controlador/Modulos/libros_controlador.php" style="display:inline;">
            ...
            <section id="formularioLibro" style="display: none;">
                <form id="form_libro" action="../../Controlador/Modulos/libros_controlador.php" method="POST">
