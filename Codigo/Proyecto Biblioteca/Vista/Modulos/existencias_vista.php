...
<?php include __DIR__ . '/../Helpers/templates/sidebar.php'; ?>
    ...
    <div class="main-content">
        ...
        <form method="POST" action="../../Controlador/Modulos/existencia_controlador.php" class="formulario-agregar">
        ...
        <div id="formModificar" class="form-modificar">
             <div class="formulario-modificar">
                <h2>Modificar Existencia</h2>
                 <form method="POST" action="../../Controlador/Modulos/existencia_controlador.php">
