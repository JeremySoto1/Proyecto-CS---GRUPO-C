<?php
require_once '../../Modelo/Modulos/existencias_modelo.php';
...
if (isset($_POST['guardar_existencia'])) {
    ...
    if ($resultado) {
        ...
        header("Location: ../../Vista/Modulos/existencias.php?exito=1");
        exit();
    } else {
...
if (isset($_POST['accion']) && $_POST['accion'] === 'modificar') {
    $existenciaID = $_POST['existenciaID'];
        ...
        if ($resultado) {
            // Redirecciona con mensaje de éxito
            header("Location: ../../Vista/Modulos/existencias.php?modificado=1");
            exit();
        } else {
            // Muestra error
