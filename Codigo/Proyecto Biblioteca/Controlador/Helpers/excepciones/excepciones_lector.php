...
class LectorBloqueadoException extends SistemaException {
    public function __construct($message = "Lector no disponible por multa no pagada", $code = 502, Throwable $previous = null) {
        parent::__construct($message, $code, $previous);
    }
}

class LectorConPrestamosException extends SistemaException {
    public function __construct($message = "El lector tiene préstamos activos", $code = 503, Throwable $previous = null) {
        parent::__construct($message, $code, $previous);
    }
}